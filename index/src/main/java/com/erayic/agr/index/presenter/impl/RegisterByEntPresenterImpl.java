...
public class RegisterByEntPresenterImpl implements IRegisterByEntPresenter {
    ...
    @Override
    public void enterpriseRegister(String tel, String name, String entName, String password, String verCode,String identifier) {
        indexModel.enterpriseRegister(entName, name, password, tel, AgrConstant.AGR_APPID, identifier, verCode, new OnDataListener<Object>() {
            @Override
