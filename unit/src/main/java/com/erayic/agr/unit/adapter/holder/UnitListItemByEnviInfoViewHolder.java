...
public class UnitListItemByEnviInfoViewHolder extends BaseViewHolder {
    ...
    @BindView(R2.id.unit_content_sub)
    public TextView unitContentSub;
    @BindView(R2.id.manage_content_goto)
    public ImageView manageContentGoto;

    public UnitListItemByEnviInfoViewHolder(View view) {
        super(view);
