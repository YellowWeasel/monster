...
//                .baseUrl("http://weixin.erayic.com/")
//                .build();
//        IHttpUpdateAppService apiStores = retrofit.create(IHttpUpdateAppService.class);
//        Call<ResponseBody> call = apiStores.asyncGet(url);
...
//                .build();
//        IHttpUpdateAppService apiStores = retrofit.create(IHttpUpdateAppService.class);
//        Call<ResponseBody> call = apiStores.asyncPost(url, params);
//        call.enqueue(new retrofit2.Callback<ResponseBody>() {
//            @Override
//            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
//                try {
