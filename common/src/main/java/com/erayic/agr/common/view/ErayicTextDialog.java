...
public class ErayicTextDialog extends Dialog {
    ...
    protected ErayicTextDialog(Context context, int theme) {
        super(context, theme);
        this.context = context;
    }

    protected ErayicTextDialog(Context context) {
        this(context, R.style.ErayicDialogStyle);
    }

    protected ErayicTextDialog(Context context, boolean cancelableOnTouchOutside) {
        this(context);
    ...
    public static class Builder {
        ...
        private ErayicTextDialog dialog;
        private Context context;
        ...
        private View view;
        private ErayicTextDialog.OnClickListener button1Listener;
        private ErayicTextDialog.OnClickListener button2Listener;
        private ErayicTextDialog.OnClickListener button3Listener;
        private ErayicTextDialog.OnLinearClickListener linearListener;
        private int button1Flag;
        private int button2Flag;
        private int button3Flag;

        public Builder(Context context, int theme) {
            dialog = new ErayicTextDialog(context, theme);
            this.context = context;
            initData();
        }

        public Builder(Context context) {
            dialog = new ErayicTextDialog(context);
            this.context = context;
            initData();
        }
        ...
        public Builder setMessage(CharSequence message, ErayicTextDialog.OnLinearClickListener listener) {
            this.message = message;
            this.linearListener = listener;
            return this;
        }

        public Builder setMessage(int messageResId, ErayicTextDialog.OnLinearClickListener listener) {
            this.message = context.getResources().getString(messageResId);
            this.linearListener = listener;
            return this;
        }

        public Builder setMessage2(CharSequence message, ErayicTextDialog.OnLinearClickListener listener) {
            this.message2 = message;
            this.linearListener = listener;
            return this;
        }

        public Builder setMessage2(int messageResId, ErayicTextDialog.OnLinearClickListener listener) {
        ...
        public Builder setButton1(CharSequence text,
                                  ErayicTextDialog.OnClickListener listener) {
        ...
        public ErayicTextDialog create() {
            ...
            mView = LayoutInflater.from(context).inflate(
                    R.layout.erayic_dialog_text_titlebar, null);
