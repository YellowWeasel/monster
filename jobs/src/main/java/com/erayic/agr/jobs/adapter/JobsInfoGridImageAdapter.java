 ...
 * data：16/7/27
 */
public class JobsInfoGridImageAdapter extends
        RecyclerView.Adapter<JobsInfoGridImageAdapter.ViewHolder> {
    public static final int TYPE_CAMERA = 1;
    public static final int TYPE_PICTURE = 2;
    private LayoutInflater mInflater;
    private List<JobsLocalMedia> list = new ArrayList<>();
    ...
    public JobsInfoGridImageAdapter(Context context, onAddPicClickListener mOnAddPicClickListener) {
    ...
    public void setList(List<JobsLocalMedia> list) {
        this.list = list;
    }

    public List<JobsLocalMedia> getList() {
        return list;
    }
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, final int position) {
        ...
        if (isEdit && (getItemViewType(position) == TYPE_CAMERA)) {
            ...
            JobsLocalMedia media = list.get(position);
